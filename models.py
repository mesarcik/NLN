...
class Encoder(tf.keras.layers.Layer):
    def __init__(self,args):
        ...
        self.conv.append(layers.Conv2D(n_filters*2, (2, 2), strides=1, activation=layers.LeakyReLU(alpha=0.2), padding='same'))
...
class Decoder(tf.keras.layers.Layer):
    def __init__(self,args):
        ...
        self.conv.append(layers.Conv2DTranspose(n_filters, (8, 8), strides=2, activation=layers.LeakyReLU(alpha=0.2), padding='valid'))
        self.conv.append(layers.Conv2D(n_filters*2, (3, 3), strides=1, activation=layers.LeakyReLU(alpha=0.2), padding='same'))
        self.conv.append(layers.Conv2DTranspose(n_filters*4, (4, 4), strides=2, activation=layers.LeakyReLU(alpha=0.2), padding='same'))
        self.conv.append(layers.Conv2D(n_filters*2, (2, 2), strides=1, activation=layers.LeakyReLU(alpha=0.2), padding='same'))
        self.conv.append(layers.Conv2D(n_filters, (3, 3), strides=1, activation=layers.LeakyReLU(alpha=0.2), padding='same'))
