...
from utils.data import get_mvtec_images, process,get_patched_dataset
...
def load_mvtec(args):
    ...
    """
    (train_images, train_labels), (test_images, test_labels) = get_mvtec_images(args.anomaly_class)
